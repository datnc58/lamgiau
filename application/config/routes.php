...
$route['uetadmin/([a-zA-Z0-9_-]+)/([a-zA-Z0-9_-]+)'] = 'admin/$1/$2';
$route['website/([a-zA-Z0-9_-]+)/([a-zA-Z0-9_-]+)'] = 'website/$1/$2';

$route['uetadmin/([a-zA-Z0-9_-]+)/([a-zA-Z0-9_-]+)/([a-zA-Z0-9_-]+)'] = 'admin/$1/$2/$3';
$route['website/([a-zA-Z0-9_-]+)/([a-zA-Z0-9_-]+)/([a-zA-Z0-9_-]+)'] = 'website/$1/$2/$3';

/*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/



$route['uetadmin'] = 'admin/defaults/index';

$route['uetadmin/doi-mat-khau'] = 'admin/admin/admin_change_password';

$route['uetadmin/site_option'] = 'admin/admin/site_option';

$route['uetadmin/huong-dan-su-dung'] = 'admin/admin/documentation';

//Modules=================================================================

$route['uetadmin/danh-sach-modules'] = 'admin/modules/list';

$route['uetadmin/quan-ly-modules'] = 'admin/modules/modulemanager';

$route['uetadmin/edit-modules/(:num)'] = 'admin/modules/modulemanager/$1';

$route['uetadmin/delete-module/(:num)'] = 'admin/modules/delete/$1';



//phan quyen admin

$route['uetadmin/admin-permission'] = 'admin/admin/admin_permission';

$route['uetadmin/admin-permission-edit/(:num)'] = 'admin/admin/admin_permission/$1';

$route['uetadmin/admin-reset-pass/(:num)'] = 'admin/admin/reset_pass/$1';

$route['uetadmin/admin-permission-delete/(:num)'] = 'admin/admin/delete_acc/$1';
...
$route['uetadmin/menu/savelist'] = 'admin/menu/saveList';

                ...
                <div class="col-md-12">
                    ...
                    <div class="main-block">
                        <div class="prod-list-link clearfix">
                            ...
                            <h2 class="section-title"><a href="<?= base_url('danh-muc/'.$cate_curent->alias.'.html')?>"><img alt="<?= $cate_curent->name?>" src="<?= base_url()?>img/icon_product_home_1.png"> <?= $cate_curent->name?></a></h2>

    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-aqua">
                ...
                <a href="<?=base_url('uetadmin/order/orders')?>" class="small-box-footer">Xem thêm <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div><?php } ?>
        <!-- ./col -->
       <?php if(isset($module_news)){ ?>
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-red">
                ...
                <a href="<?= base_url('uetadmin/news/newslist')?>" class="small-box-footer">Xem thêm <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-green">
                ...
                <a href="<?= base_url('uetadmin/product/products')?>" class="small-box-footer">Xem thêm <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-yellow">
                ...
                <a href="<?= base_url('uetadmin/users/listusers')?>" class="small-box-footer">Xem thêm <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div><?php } ?>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-yellow">
                ...
                <a href="<?= base_url('uetadmin/contact/contacts')?>" class="small-box-footer">Xem thêm <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-aqua">
                ...
                <a href="<?= base_url('uetadmin/email/emails')?>" class="small-box-footer">Xem thêm <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-red">
                ...
                <a href="<?= base_url('uetadmin/comment/comments')?>" class="small-box-footer">Xem thêm <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div><?php } ?>
    </div>
    <!-- /.row -->
						...
						<tbody>
							...
							<tr role="row" class="odd">
								...
								<a class="btn btn-xs btn-danger"
								   ...
								   href="<?= base_url('uetadmin/order/delete/' . $v->id) ?>" title="Xóa"

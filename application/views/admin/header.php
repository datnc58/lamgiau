...
<?php if($this->session->userdata('phanquyen')) {
    ...
    <li><a href="<?= base_url('uetadmin/admin/documentation')?>"><i class="fa fa-book"></i> <span>Hướng dẫn quản trị</span></a></li>
<!-- chi hien thị trên may noi bo khi xuat ra se k co -->
		<!-- <li><a href="<?= base_url('uetadmin/admin/setup_wiget')?>"><i class="fa fa-book"></i> <span>Cấu hình wiget</span></a></li> -->
<!-- DONG KHOI -->

...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('uetadmin/comment/comments')?>">Danh sách bình luận</a></li>
    ...
    <!-- Page Heading -->
	 <div class="box">
		...
		<div class="box-body">
			...
			<form name="formbk" method="post" action="<?=base_url('uetadmin/comment/deletes')?>">
					...
					<tbody>
						...
						<tr>
							...
							<td class="text-center">
								...
								<a href="<?= base_url('uetadmin/comment/delete/'.$v->id)?>"

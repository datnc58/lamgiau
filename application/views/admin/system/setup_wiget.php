...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('uetadmin/admin/setup_wiget')?>">Cấu hình widget</a></li>
                              ...
                              <td class="text-center">
                                 <div class="btn-group">
                                  ...
                                  class="btn btn-xs btn-default" title="Sửa"><i class="fa fa-pencil"></i></a>
                                    <a href="<?= base_url('uetadmin/admin/xoa_config_banner/' .$bn->id) ?>"
                  ...
                  // them nút hiện thị
                      function getModal_wiget_show() {
                          ...
                          $.ajax({
                              type: "GET",
                              dataType:"html",
                              url: base_url() + 'uetadmin/admin/popupdata_wiget',
                              data: "",
